...
<body>
    ...
    <main>
    	<div id="main_wrapper">
            ...
            <hr><br>
            <div id="button_box">
                <input type="button" value="목록으로" onclick="location.href='notice_management'">
                <input type="button" value="수정하기" onclick="location.href='notice_management_modify'">
                <input type="button" value="삭제하기" onclick="location.href='notice_management_deleteAction'">
            </div>
    	</div>
    </main>
    <footer>
