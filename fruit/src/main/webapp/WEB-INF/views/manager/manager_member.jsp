...
/* main */
       ...
       #membership{ /* 멤버쉽 네모 박스 */
        ...
        #main_content {
            ...
            padding: 30px 100px 30px 118px;
        }
        #main_content table{ 
            width: 800px;
        }
        #main_content input{ /* 아이디 비번 입력창 */
            margin-top: 10px;
            height: 45px;
            width: 300px;
        }
...
<body>
    ...
    <div id="main_wrapper">
            ...
            <div id="main_left">
                <h3><b>회원관리</b></h3>
                <table>
                    <tr onClick="location.href='member_list'"><td><small>회원 목록</small></td><td>></td></tr>
                    <tr onClick="location.href='member_secession'"><td><small>탈퇴 회원</small></td><td>></td></tr>
				...
				<form action="MypagePasswordAction" method="POST" id="password_check">
	                <div id="main_content">
	                        <table>
	                            <tr>
	                                <td>아이디</td>
	                                <td><input type="text" value="hong" name="name"></td>
	                            </tr>
	                            <tr>
	                                <td>비밀번호</td>
