    ...
    <main>
        <div id="wrapper">
          ...
          <div id="yak">
            ...
            <h5><b>제1장 총 칙</b></h5><br>
             
            
            제1조(목적)<br>
            이 약관은 해피퍼피(이하 "회사"라 한다)이 홈페이지(saac.kr)에서 제공하는 모든 서비스(이하 "서비스"라 한다)의 이용조건 및 절차에 관한 사항을 규정함을 목적으로 합니다. <br><br> 
            
            제2조(정의) <br>
            이 약관에서 사용하는 용어의 정의는 다음 각 호와 같습니다. <br>
            1. 이용자 : 본 약관에 따라 회사가 제공하는 서비스를 받는 자<br>
            2. 이용계약 : 서비스 이용과 관련하여 회사와 이용자간에 체결하는 계약<br>
            3. 가입 : 회사가 제공하는 신청서 양식에 해당 정보를 기입하고, 본 약관에 동의하여 서비스 이용계약을 완료시키는행위<br>
            ...
            7. 이용해지 : 회사 또는 회원이 서비스 이용 이후 그 이용계약을 종료시키는 의사표시<br><br>
            ...
            <h5><b>제4장 서비스 이용</b></h5> <br>
             
            
            제11조(회원의 의무)<br>
            ① 회원은 필요에 따라 자신의 메일, 게시판, 등록자료 등 유지보수에 대한 관리책임을 갖습니다. <br>
            ② 회원은 회사에서 제공하는 자료를 임의로 삭제, 변경할 수 없습니다.<br>
            ③ 회원은 회사의 홈페이지에 공공질서 및 미풍양속에 위반되는 내용물이나 제3자의 저작권 등 기타권리를 침해하는 내용물을 등록하는 행위를 하지 않아야 합니다. <br>
               만약 이와 같은 내용물을 게재하였을 때 발생하는 결과에 대한 모든 책임은 회원에게 있습니다. <br><br>
            ...
            부 칙 <br>
            (시행일) 이 약관은 2020년 11월 26일부터 시행합니다. <br><br>
          </div>
        </div>
    </main><br><br>
    <footer>
